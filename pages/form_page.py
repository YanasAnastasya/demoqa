...
class FormPage(BasePage):
    ...
    def fill_fields_and_submit(self):
        ...
        self.element_is_visible(Locators.MOBILE).send_keys('2155555555')
        ...
        self.element_is_visible(Locators.FILE_INPUT).send_keys(r'C:\Users\unas\PycharmProjects\pythonProject\image_env\test.txt')
